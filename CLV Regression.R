...
autotest=read.csv("CLV test.csv")
...
# Standardize all the real valued variables in the dataset as some models we use might be
#impacted due to non standardized variables
